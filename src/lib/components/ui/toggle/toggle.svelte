<script module>
	...
	export const toggleVariants = tv({
		base: 'ring-offset-background hover:text-muted-foreground focus-visible:ring-ring data-[state=on]:text-accent-foreground inline-flex items-center justify-center gap-2 rounded-xl text-sm font-thin transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
		variants: {
			variant: {
