...
const buttonVariants = tv({
	...
	variants: {
		variant: {
			...
			secondary:
				'bg-gradient-to-br from-[#3D3A4B] via-secondary/40 via-30% text-secondary-foreground hover:from-[#afffdc] hover:via-primary hover:to-primary hover:text-secondary highlightSecondary active:scale-95 transition-all',
			ghost:
