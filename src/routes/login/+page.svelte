...
<div class="mt-0 flex md:min-h-[80vh] flex-col items-center justify-center">
  ...
  <Card.Root class="w-[23rem] lg:w-[25rem] mt-6">
    <Card.Content class="grid gap-4 pb-6 pt-6">
      ...
      {#if import.meta.env.DEV}
        <div class="mt-4 p-2 bg-orange-500/10 border border-orange-500/30 rounded text-xs">
          <strong>Dev Info:</strong> PocketBase URL: {import.meta.env.VITE_POCKETBASE_URL || 'Not set'}
          <br>
